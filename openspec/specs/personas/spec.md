...
Defines the responsibilities, outputs, and handoff contracts for Software Fabric agent personas.
...
The following requirements define the persona responsibilities and handoff contracts.
