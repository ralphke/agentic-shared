...
Defines deployment, observability, SLO, runbook, and incident-response requirements for the Software Fabric.
...
- AND state is stored in the configured remote backend
