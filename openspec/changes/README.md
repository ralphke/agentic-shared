...
```
cp openspec/templates/idea-to-spec.md openspec/changes/<slug>/proposal.md
```

See `openspec/config.yaml` for project-level settings.
See `openspec/specs/` for the current source-of-truth specs.
