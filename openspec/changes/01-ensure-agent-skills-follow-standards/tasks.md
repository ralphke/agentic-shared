...
- [x] T01 — Request and capture @ralphke review/approval of `proposal.md` before execution.
...
- [x] T05 — Update `.github/skills/*.md` files to align structure, intent clarity, and optimization guidance.
